...
## 1. 模块简介
- **论文地址**: [https://arxiv.org/pdf/2301.11525](https://arxiv.org/pdf/2301.11525)
- **源文件**: `(arXiv 2023) MHRSA.py`
...
### 类定义与参数
#### `class MLP`
- **描述**: Multilayer Perceptron (MLP)
- **初始化参数**: `channel, bias`

#### `class MHRSA`
- **描述**: Multi-Head Recurrent Spectral Attention
    
- **初始化参数**: `channels, multi_head, ffn`

## 3. 使用示例
```python
# 导入方式（参考）：from (arXiv 2023) MHRSA import ...
