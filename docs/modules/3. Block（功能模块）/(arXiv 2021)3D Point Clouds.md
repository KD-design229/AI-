...
## 1. 模块简介
- **相关论文/地址**: [https://arxiv.org/pdf/2108.07378](https://arxiv.org/pdf/2108.07378)
...
## 3. 使用建议
- **集成方式**: 直接将 `(arXiv 2021)3D Point Clouds.py` 中的代码复制到项目中，或者通过 `from (arXiv 2021)3D Point Clouds import PnP3D` 引入。
